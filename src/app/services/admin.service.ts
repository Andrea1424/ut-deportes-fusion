...
export class AdminService {
  ...
  URL = "http://sseutvco.dyndns-server.com/tutorias/admin/";
  ...
  buscarEstudiante(matricula: any) {
    return this.http.get(
      `${this.URL}estudiantes/buscar.php?matricula=${matricula}`
    );
  }

  buscarActividadEstudiante(actividad: number, matricula: any) {
    return this.http.get(
      `${this.URL}estudiantes/buscarActividad.php?idActividad=${actividad}&matricula=${matricula}`
    );
  }

  getActividades(id: number) {
    return this.http.get(
      `${this.URL}actividades/getAllId.php?idTipoActividad=${id}`
    );
  }

  getActividad(id: number) {
    return this.http.get(
      `${this.URL}actividades/getOneId.php?idActividad=${id}`
    );
  }

  getEstudiantes(id: number) {
    return this.http.get(
      `${this.URL}estudiantes/getAllId.php?idActividad=${id}`
    );
  }
  ...
  countActividadesInstructor(id: any) {
    return this.http.get(
      `${this.URL}instructores/count.php?idInstructor=${id}`
    );
  }

  buscarEstudianteInstructor(matricula: any, id: any) {
    return this.http.get(
      `${this.URL}instructores/buscar.php?matricula=${matricula}&idInstructor=${id}`
    );
  }
  ...
  updateActividad(id: any, actividad: any) {
    return this.http.post(
      `${this.URL}actividades/update.php?idActividad=${id}`,
      actividad
    );
  }
  ...
  buscarNombreActividad(actividad: any) {
    return this.http.get(
      `${this.URL}actividades/getId.php?actividad=${actividad}`
    );
  }

  getActividadesInstructorTipo(tipo: number, id: any) {
    return this.http.get(
      `${this.URL}actividades/getAllIdInstructor.php?idTipoActividad=${tipo}&idInstructor=${id}`
    );
  }
  ...
  deleteHorarioId(id: any) {
    return this.http.get(
      `${this.URL}horarios/deleteAllId.php?idActividad=${id}`
    );
  }

  verificarActividad(id: any) {
    return this.http.get(
      `${this.URL}actividades_usuarios/count.php?idActividad=${id}`
    );
  }
  ...
  getActividadesInstructor(id: any) {
    return this.http.get(
      `${this.URL}actividades/getAllInstructor.php?idInstructor=${id}`
    );
  }
  ...
  getPublicacionesId(id: any) {
    return this.http.get(
      `${this.URL}publicaciones/getAllId.php?idInstructor=${id}`
    );
  }

  eliminarPublicacion(id: any) {
    return this.http.get(
      `${this.URL}publicaciones/delete.php?idPublicacion=${id}`
    );
  }
}
